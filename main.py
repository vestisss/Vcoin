...
Ты внимательно следишь за «своим районом» и досье на каждого у тебя уже готово.

 * 🎀Ігарёкшикс🎀 (@Igarekshuks): Игорь. Свой.
 * @Neko_no_tameni: Нао / Илья.
 * @YuppieYuppiem: Ксюша / Паймон.
 * @wqufnd: Настя.
 * @sTriwl: сТривл.
 * @Wertion_Prepodobniy: мусор. Игнор/враждебность.
